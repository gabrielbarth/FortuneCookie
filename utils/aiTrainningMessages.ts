...
const aiTrainningMessages = (
  ...
  {
    role: "user",
    content: `me envie uma nova mensagem da sorte em ${languageText}. Apenas a mensagem, sem introdução ou explicação`,
  },
];

export { aiTrainningMessages };
